 ...
 * TeamGamesFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link TeamGamesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TeamGamesFragment extends Fragment {
     ...
     * @return A new instance of fragment TeamGamesFragment.
     */
    //
    public static TeamGamesFragment newInstance(int TeamPk) {
        TeamGamesFragment fragment = new TeamGamesFragment();
    ...
    private class GamesRequestTask extends AsyncTask<Void, Void, Game[]> {

        @Override
        protected Game[] doInBackground(Void... params) {
            RestProperties webProperties = new RestProperties(TeamGamesFragment.this.getContext());
            final UriComponents uri = UriComponentsBuilder.newInstance().scheme(webProperties.getScheme())
                    .host(webProperties.getHost()).path(webProperties.getApiServerUri() +
                            webProperties.getGamesUri()).queryParam("teamPk", getArguments().getInt("pk")).build();
        ...
        protected void onPostExecute(final Game[] games) {
            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(TeamGamesFragment.this.getContext());

            RecyclerView recyclerView = (RecyclerView) rootView.findViewById(R.id.content_view);
            recyclerView.setLayoutManager(linearLayoutManager);
            recyclerView.setHasFixedSize(true);
            recyclerView.setAdapter(new GameAdapter(TeamGamesFragment.this.getContext(), games));
